...
class EmployeeAppraisal(models.Model):
    ...
    head_opinion = fields.Text(string='Head Opinion')
    superior_head_opinion = fields.Text(string='Superior Head')
    ...
    employee_opinion = fields.Text(string='Employee Opinion')
