...
class HrEmployeeInherit(models.Model):
    ...
    service_ids = fields.One2many('employee.service', 'employee_id', string='Service')
...
class EmployeeService(models.Model):
    ...
    service_start_date = fields.Date(string='Start Date')
    service_end_date = fields.Date(string='End Date')

    service_remarks = fields.Text(string='Remarks')
