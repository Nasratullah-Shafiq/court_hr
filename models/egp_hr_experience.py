...
class EmployeeExperience(models.Model):
    ...
    status_id = fields.Many2one('employee.status', string="Status", required=True, tracking=True)
    ...
    organization_type = fields.Selection([('Civil', 'Civil'), ('Military', 'Military'), ('NGO', 'NGO'),
                                          ...
                                          ('united_nations', 'United Nations')], string="Organization Type", tracking=True)
    job_remarks = fields.Text(string='Remarks', tracking=True)
...
class EmployeeStatus(models.Model):
    ...
    name = fields.Char(string='Status', tracking=True)
...
class EmployeeGrade(models.Model):
    ...
    name = fields.Char(string='Grade', required=True, translate=True, unique=True, tracking=True)
